...
//! stored-vertex counts binned by local density, plus the asset size
//! delta. The visual comparison lives in the live viewer (regenerated by
//! `visualize`), which has a per-layer pop-weight toggle and the density
//! heatmap.
//!
//! ```text
//! utz-dev-cli density-compare [ds] [eps_m] [w_min]
//! ```
